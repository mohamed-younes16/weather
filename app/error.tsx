  ...
  return (
    <div className=' w-screen h-screen fixed inset-0 flex flex-col gap-4 justify-center items-center'>
        ...
        <div className="flex gap-4">
                ...
                <Button className="dark:bg-white text-2xl hover:text-white   p-2 transition hover:!bg-black rounded-lg" onClick={()=>location.reload()} >try Again </Button>
                <Button className="dark:bg-white  text-2xl w-28   hover:text-white transition hover:!bg-black rounded-lg"onClick={()=>router.push("/")}> Home </Button>
            </div>
    </div>
  )
}
