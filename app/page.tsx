...
export default function Home() {
  return (
    <main className=" h-screen overflow-x-hidden flex items-center justify-center">
     
     <Card decoration="top" className=" flex max-w-4xl  items-center flex-col bg-white" 
      decorationColor="indigo" 
      >
        <p className=" font-bold dark:text-blue-100   text-4xl mb-12">
          Weaher Ai /Api
        </p>
          <Subtitle className=" max-w-sm dark:text-blue-100 text-xl">
            Powered By Open Ai and Nextjs13.4, Tailwindcss,Tremor 2.0 , 
            and more  
          </Subtitle>
