...
export default function Home() {
  return (
    <main
      ...
      className="px-2 h-screen overflow-x-hidden flex items-center justify-center"
    >
      <Card
        decoration="top"
        className=" flex max-w-4xl  items-center flex-col bg-white"
      ...
      >
        ...
        <Subtitle className=" max-w-sm  dark:text-blue-100 text-xl">
          Powered Nextjs 13.4, Tailwindcss,Tremor 2.0 , and more
        </Subtitle>
